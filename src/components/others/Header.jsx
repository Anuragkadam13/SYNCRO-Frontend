  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between  mx-5">
      ...
      <div className="flex flex-col items-center md:items-start">
        <h1 className="text-3xl font-extrabold tracking-tighter bg-linear-to-r from-blue-400 to-blue-900 bg-clip-text text-transparent uppercase">
          Syncro
        </h1>
        <p className="text-xs text-gray-400 font-medium italic tracking-wider">
